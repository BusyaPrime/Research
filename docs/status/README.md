...
Когда проект большой, очень легко попасть в режим “вроде почти всё есть”. Обычно именно в этот момент выясняется, что “почти” сидит в самых дорогих местах: release-hardening, vendor adapters, optimizer, figure rendering и прочих радостях жизни.
