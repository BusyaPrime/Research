...
Когда проект большой, очень легко попасть в режим “вроде почти всё есть”. Обычно именно в этот момент выясняется, что “почти” сидит в самых дорогих местах: live ops вокруг внешних адаптеров, soak-прогоны против реального поставщика и прочих радостях жизни.
