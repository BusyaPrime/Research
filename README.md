...
- Команды ingest уже operational и сохраняют raw/bronze/manifests как положено, но сам источник пока synthetic vendor stub, а не живой внешний поставщик.
- В пайплайне остается несколько честно помеченных временных упрощений, но самый неприятный хвост уже не в портфельном optimizer'е, а в real vendor adapters и финальном release-hardening.
